...
proc create_root_design { parentCell } {
  ...
  # Create instance: inference_0, and set properties
  set inference_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:inference:1.0 inference_0 ]
...
\
  ...
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins comblock_0/fifo_data_o] [get_bd_pins inference_0/input_r_TDATA]
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins comblock_0/fifo_valid_o] [get_bd_pins inference_0/input_r_TVALID]
  connect_bd_net -net comblock_0_reg0_o [get_bd_pins comblock_0/reg0_i] [get_bd_pins comblock_0/reg0_o]
  connect_bd_net -net comblock_0_reg1_o [get_bd_pins comblock_0/reg1_o] [get_bd_pins inference_0/ap_start]
  connect_bd_net -net inference_0_result_ap_vld [get_bd_pins comblock_0/reg1_i] [get_bd_pins inference_0/result_ap_vld]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_smc/aclk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins inference_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins comblock_0/axil_aresetn] [get_bd_pins inference_0/ap_rst_n] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins comblock_0/fifo_clear_i] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins comblock_0/fifo_re_i] [get_bd_pins xlconstant_1/dout]
